...
== Changelog ==
= 1.1.7 =
* Fix: Dashboard tooltips text 

= 1.1.6 =
* Update: Active chats order

= 1.1.5 =
* Update: add user disconnect feature for more friendly user experience 
...
= 1.0.7 =
* Any text you like. Any language you need. Just click and edit. 
